...
<a href="start0.php" class="pull-right btn logb btn-primary" style="color:white"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;<font style="font-size:12px;font-weight:bold">Home</font></a>&nbsp;
</div></div>
...
<!-- Text input-->
<div class="form-group">
  <input id="name" name="name" placeholder="Masukkan Nama Anda" class="form-control input-md" type="text">    
</div>
</div>
</div><!--End of row-->
<div class="row">
...
<!-- Text input-->
<div class="form-group">
   <input id="name" name="subject" placeholder="Masukkan Subject Feedback Anda" class="form-control input-md" type="text">    
</div>
</div>
</div><!--End of row-->
<div class="row">
...
<!-- Text input-->
<div class="form-group">
  <input id="email" name="email" placeholder="Masukkan Email Anda" class="form-control input-md" type="email">    
 </div>
</div>
</div><!--End of row-->
<div class="form-group"> 
<textarea rows="5" cols="8" name="feedback" class="form-control" placeholder="Tulis feedback disini. Pastikan Sopan dan Jelas."></textarea>
</div>
...
<marquee>
<span href="#" data-target="#login" style="color:lightyellow" >Website by Brian Ahmad Taufik&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Website by Brian Ahmad Taufik&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Website by Brian Ahmad Taufik<br></span></div></marquee>
</body>
</html>
