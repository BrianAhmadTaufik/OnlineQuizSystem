...
<tr><td style="vertical-align:middle"><b>No.</b></td><td style="vertical-align:middle"><b>Topik</b></td><td style="vertical-align:middle"><b>Jumlah Soal</b></td><td style="vertical-align:middle"><b>Total Poin</b></td><td style="vertical-align:middle"><b>Batas Waktu</b></td><td style="vertical-align:middle"><b>Status</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Nama</b></td><td style="vertical-align:middle"><b>Jurusan</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>NRP</b></td><td style="vertical-align:middle"><b>Jenis Kelamin</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    $c = $showfrom-1;
...
<tr><td style="vertical-align:middle"><b>No.</b></td><td style="vertical-align:middle"><b>Nama</b></td><td style="vertical-align:middle"><b>Jenis Kelamin</b></td><td style="vertical-align:middle"><b>NRP</b></td><td style="vertical-align:middle"><b>Jurusan</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>No Telepon</b></td><td style="vertical-align:middle"></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $name      = $row['name'];
        $phno      = $row['phno'];
...
if (@$_GET['q'] == 3) {
    ...
    echo '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td style="vertical-align:middle"><b>No.</b></td><td style="vertical-align:middle"><b>Subject</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Tanggal</b></td><td style="vertical-align:middle"><b>Waktu</b></td><td style="vertical-align:middle"><b>Pengirim</b></td><td style="vertical-align:middle"></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $date      = $row['date'];
...
if (@$_GET['q'] == 4 && !(@$_GET['step'])) {
    echo ' 
<div class="row">
<span class="title1" style="margin-left:37%;font-size:30px;"><b>Masukkan Detail Quiz</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST">
<fieldset>
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Masukkan Topik Quiz" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="total" name="total" placeholder="Masukkan Jumlah Soal" class="form-control input-md" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="Masukkan Poin Jawaban Benar" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="wrong" name="wrong" placeholder="Masukkan Poin Minus Jawaban Salah" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="time" name="time" placeholder="Masukkan batas waktu dalam menit" class="form-control input-md" min="1" type="number">
...
if (@$_GET['q'] == 4 && (@$_GET['step']) == 2) {
    echo ' 
<div class="row">
<span class="title1" style="margin-left:37%;font-size:30px;"><b>Masukkan Detail Soal</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="3" cols="5" name="qns' . $i . '" class="form-control" placeholder="Tulis soal no ' . $i . ' disini"></textarea>  
  </div>
</div>
<div class="form-group">
  <label class="col-md-12 control-label" for="' . $i . '1"></label>  
  <div class="col-md-12">
  <input id="' . $i . '1" name="' . $i . '1" placeholder="Masukkan pilihan a" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="' . $i . '2" name="' . $i . '2" placeholder="Masukkan pilihan b" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="' . $i . '3" name="' . $i . '3" placeholder="Masukkan pilihan c" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="' . $i . '4" name="' . $i . '4" placeholder="Masukkan pilihan d" class="form-control input-md" type="text">
...
<select id="ans' . $i . '" name="ans' . $i . '" placeholder="Pilih jawaban yang benar" class="form-control input-md" >
   <option value="a">Pilih Jawaban Untuk Soal no ' . $i . '</option>
...
if (@$_GET['q'] == 5) {
    ...
    $result = mysqli_query($con, "SELECT * FROM quiz ORDER BY date DESC") or die('Error');
    echo '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td style="vertical-align:middle"><b>No.</b></td><td style="vertical-align:middle"><b>Topik</b></td><td style="vertical-align:middle"><b>Jumlah Soal</b></td><td style="vertical-align:middle"><b>Poin</b></td><td style="vertical-align:middle"><b>Batas Waktu</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $title   = $row['title'];
        $total   = $row['total'];
