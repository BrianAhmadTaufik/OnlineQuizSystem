...
if (@$_GET['q'] == 3)
    echo 'class="active"';
?>><a href="account.php?q=3"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Rangking</a></li>
 <li <?php
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="game2.html"><span id="Error"><span class="glyphicon glyphicon-play-circle" aria-hidden="true"></span>&nbsp;Mini Games</a></span></li>
 <li <?php
if (@$_GET['q'] == 5)
    echo 'class="active"';
?>><a href="logout.php"><span class="glyphicon glyphicon-road" aria-hidden="true"></span>&nbsp;Logout</a></li></ul>
      </div>
  </div>
</nav>
<div class="container">
...
if (@$_GET['q'] == 1) {
    ...
    echo '<div class="panel"><div class="table-responsive"><table class="table table-striped title1"  style="vertical-align:middle">
<tr><td style="vertical-align:middle"><b>No.</b></td><td style="vertical-align:middle"><b>Topik</b></td><td style="vertical-align:middle"><b>Jumlah Soal</b></td><td style="vertical-align:middle"><b>Nilai Benar</b></td><td style="vertical-align:middle"><b>Nilai Salah</b></td><td style="vertical-align:middle"><b>Total Poin</b></td><td style="vertical-align:middle"><b>Batas Waktu</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
  ...
  <td style="vertical-align:middle"><b><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result</b></span></a></b></td></tr>';
    ...
    $c = 0;
    echo '</table></div><div class="panel" style="padding-top:1px;word-wrap:break-word" id="ins"><h3 align="center" style="font-family:calibri">:: Instruksi Umum::</h3><br /><ul type="circle"><font style="font-size:14px;font-family:calibri" table-responsive>';
...
function end(){
  data = prompt("Anda yakin akan mengakhiri Kuis ini? Ingat, setelah selesai, Anda tidak akan dapat melanjutkan lagi dan hasil akhir akan ditampilkan. Jika Anda ingin melanjutkan maka masukkan \\"yes\\" di kotak teks di bawah ini dan tekan enter");
  if(data=="yes"){
...
<center><h1 class="title" style="color:#660033">Result</h1><center><br /><div class="table-responsive"><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
      ...
      <tr style="color:darkgreen"><td style="vertical-align:middle">Jawaban Benar&nbsp;<span class="glyphicon glyphicon-ok-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $r . '</td></tr> 
    <tr style="color:red"><td style="vertical-align:middle">Jawaban Salah&nbsp;<span class="glyphicon glyphicon-remove-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $w . '</td></tr>
    <tr style="color:orange"><td style="vertical-align:middle">Jawaban Kosong&nbsp;<span class="glyphicon glyphicon-ban-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . ($total - $r - $w) . '</td></tr>
    <tr style="color:darkblue"><td style="vertical-align:middle">Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
        ...
        while ($row = mysqli_fetch_array($q)) {
            $s = $row['score'];
            echo '<tr style="color:#990000"><td style="vertical-align:middle">Total Score&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
        }
        echo '<tr></tr></table></div><div class="panel"><br /><h3 align="center" style="font-family:calibri">:: Detail Analisa ::</h3><br /><ol style="font-size:20px;font-weight:bold;font-family:calibri;margin-top:20px">';
        ...
        while ($row = mysqli_fetch_array($q)) {
            ...
            if ($correctans == $ans && $ans != "Unanswered") {
                ...
                echo '<font style="font-size:14px;color:darkgreen"><b>Jawaban Kamu: </b></font><font style="font-size:14px;">' . $ans . '</font><br />';
                echo '<font style="font-size:14px;color:darkgreen"><b>Jawaban yang Benar: </b></font><font style="font-size:14px;">' . $correctans . '</font><br />';
            } 
                ...
                echo '<font style="font-size:14px;color:darkgreen"><b>Jawaban Kamu: </b></font><font style="font-size:14px;">' . $ans . '</font><br />';
                echo '<font style="font-size:14px;color:red"><b>Jawaban yang Benar: </b></font><font style="font-size:14px;">' . $correctans . '</font><br />';
...
<tr><td style="vertical-align:middle"><b>No.</b></td><td style="vertical-align:middle"><b>Topik</b></td><td style="vertical-align:middle"><b>Jumlah Soal</b></td><td style="vertical-align:middle"><b>Jawaban Benar</b></td><td style="vertical-align:middle"><b>Jawaban Salah<b></td><td style="vertical-align:middle"><b>Jawaban Kosong<b></td><td style="vertical-align:middle"><b>Score</b></td><td style="vertical-align:middle"><b>Action<b></td></tr>';
    $c = 0;
    while ($row = mysqli_fetch_array($q)) {
        $eid = $row['eid'];
        $s   = $row['score'];
...
if (@$_GET['q'] == 3) {
    ...
    echo '<div class="panel title"><div class="table-responsive">
<table class="table table-striped title1" >
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Nama</b></td><td style="vertical-align:middle"><b>Jurusan</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Total Score</b></td></tr>';
    $c = $showfrom-1;
    ...
    echo '</table></div>';
    echo '<div class="panel title"><div class="table-responsive"><table class="table table-striped title1" ><tr>';
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Contact Person</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Contact Person</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Brian Ahmad Taufik</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+62 82232600323</h4>
		<h4 style="font-family:'typo' ">brianahmad28@gmail.com</h4>
		<h4 style="font-family:'typo' ">Politeknik Elektronika Negeri Surabaya</h4></div></div>
		</p>
      </div>
